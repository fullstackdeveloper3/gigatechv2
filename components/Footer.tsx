      ...
      <div className="bg-[#040810]">
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-accent to-cyan-400 flex items-center justify-center">
                  <span className="text-xs font-black text-[#060b18]">G</span>
                </div>
              ...
              <p className="text-sm text-foreground/40 leading-relaxed">
                تقنيات الحاسبات و كاميرات المراقبة والطابعات.
                <br />
                كركوك، العراق.
              </p>
              <div className="flex items-center gap-3 mt-5">
                <a
                  ...
                  aria-label="Facebook"
                  className="w-8 h-8 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/40 hover:bg-[#1877F2] hover:text-white transition-all"
                >
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-full bg-foreground/10 flex items-center justify-center text-foreground/40 hover:bg-gradient-to-br hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7] hover:text-white transition-all"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Contact */}
            <div>
              <h4 className="text-sm font-semibold mb-4 text-foreground/70">تواصل معنا</h4>
              <ul className="space-y-3 text-sm">
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 text-foreground/40 hover:text-green-400 transition-colors"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                ...
                <li>
                  <a
                    href="https://maps.app.goo.gl/tXsxRoH4Up9tuiPr6?g_st=iw"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <p className="text-center text-xs text-foreground/25">
            &copy; {new Date().getFullYear()} گيگا تك. جميع الحقوق محفوظة.
          </p>
        </div>
      </div>
    </footer>
